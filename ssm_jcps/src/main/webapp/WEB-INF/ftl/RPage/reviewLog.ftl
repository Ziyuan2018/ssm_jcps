				...
				<div class="panel-body">
									...
									<div class="dropdown" style="padding-left: 8px;">
										...
										<ul class="dropdown-menu" role="menu"
											...
											<li role="presentation"><a role="menuitem" tabindex="-1"
												href="javascript:showAtRight('${base}/fee/queryFeesByJournalId?jId=${journal.id}&uId=${user.id}');">费用详情</a></li>
											<li role="presentation"><a role="menuitem" tabindex="-1"
					...
					<#if jPageBean.totalPage <= 2>
						<ul class="pagination" style="padding: 0px;margin:0;">
							...
							<#else>
							<li>
									<a href="javascript:showAtRight('${base}/journal/reviewLog?currPage=1')&uId=${user.id};">首页</a>
								</li>
							</#if>
							
							<#list 1..jPageBean.totalPage as n>
								<li><a href="javascript:showAtRight('${base}/journal/reviewLog?currPage=${n}&uId=${user.id}');">${n}</a></li>
							</#list>
							<li>
								<a href="javascript:showAtRight('${base}/journal/reviewLog?currPage=${jPageBean.totalPage}&uId=${user.id}');">尾页</a>
							</li>
						</ul>
					</#if>
					<#if jPageBean.totalPage gt 2>
						...
						<ul class="pagination" style="padding: 0px;margin:0;">
							...
							<li><a href="javascript:showAtRight('${base}/journal/reviewLog?currPage=${jPageBean.currPage-i}&uId=${user.id}');">上一页</a></li>
							<#else>
							<li><a href="#">上一页</a></li>
							</#if> 
							...
							<li><a href="#">下一页</a></li>
							<#else>
							<li><a href="javascript:showAtRight('${base}/journal/reviewLog?currPage=${jPageBean.currPage+i}&uId=${user.id}');">下一页</a></li>
							</#if>
						</ul>
					</#if>
