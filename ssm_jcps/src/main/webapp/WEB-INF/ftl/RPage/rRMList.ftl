			...
			<div id="wInfo" class="panel-collapse collapse in">
				<div class="panel-body">
					<table class="table table-hover" style="margin-bottom: 0px">
						...
						<tbody>
							<#assign i=0>
							<#if rRMPageBean?exists>
							<#list rRMPageBean.list as message>
							<#assign i=i+1>
							<tr>
								<td>${message.sName}</td>
								...
								<td>
									<a href="javascript:showAtRight('${base}/message/updateMM?state=2&currPage=${rRMPageBean.currPage}&mId=${message.id}&uId=${user.id}');" style="padding-left: 8px;"> 
								...
								<td>
									<a href="javascript:showAtRight('${base}/message/deleteRM?num=${i}&currPage=${rRMPageBean.currPage}&mId=${message.id}&uId=${user.id}');"
										style="padding-left: 8px;"> 
					...
					<#if rRMPageBean.totalPage != 0>
					<#if rRMPageBean.totalPage <= 2>
						<ul class="pagination" style="padding: 0px;margin:0;">
							<#if rRMPageBean.currPage == 1>
								<li>
							...
							<#list 1..rRMPageBean.totalPage as n>
								<li><a href="javascript:showAtRight('${base}/message/queryRM?id=${user.id}&currPage=${n}');">${n}</a></li>
							</#list>
							<li>
								<a href="javascript:showAtRight('${base}/message/queryRM?id=${user.id}&currPage=${rRMPageBean.totalPage}');">尾页</a>
							</li>
						</ul>
					</#if>
					<#if rRMPageBean.totalPage gt 2>
						<#assign i=1>
						<ul class="pagination" style="padding: 0px;margin:0;">
							<#if rRMPageBean.currPage gt 1>
							<li><a href="javascript:showAtRight('${base}/message/queryRM?id=${user.id}&currPage=${rRMPageBean.currPage-i}');">上一页</a></li>
							<#else>
							<li><a href="#">上一页</a></li>
							</#if> 
							<li><a href="#">${rRMPageBean.currPage}</a></li>
							<#if rRMPageBean.currPage == rRMPageBean.totalPage>
							<li><a href="#">下一页</a></li>
							<#else>
							<li><a href="javascript:showAtRight('${base}/message/queryRM?id=${user.id}&currPage=${rRMPageBean.currPage+i}');">下一页</a></li>
							</#if>
						</ul>
						</#if>
						<ul class="pagination" style="margin:0 0 0 20px;padding: 0px;">
						<li><a href="#" class="active">第</a></li>
						<li><a href="#">${rRMPageBean.currPage} / ${rRMPageBean.totalPage}</a></li>
