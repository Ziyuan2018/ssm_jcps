									...
									<div class="dropdown" style="padding-left: 8px;">
										...
										<ul class="dropdown-menu" role="menu"
											...
											<li role="presentation"><a role="menuitem" tabindex="-1"
												href="javascript:;" onclick="showAtRight('${base}/fee/updateFeesState?uId=${user.id}&fId=${fee.id}&currPage=${fPageBean.currPage}')">支付资费</a></li>
											<li role="presentation"><a role="menuitem" tabindex="-1"
												href="javascript:showAtRight('${base}/message/answerM?uId=${user.id}&mId=${fee.readerId}');">期刊详情</a></li>
										</ul>
									</div>
								</td>
							</tr>
