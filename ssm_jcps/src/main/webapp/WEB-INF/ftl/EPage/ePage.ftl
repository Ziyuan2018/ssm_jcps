						...
						<div class="container-fluid">
							...
							<div>
								<ul class="nav navbar-nav" style="margin-left: 20px;">
									<li style="background-color:#A52A2A"><a href="${base}/user/page?add=1&uId=${user.id}" style="color: #FFF;margin:0 5px 0 5px;">首页</a></li>
									<li class="dropdown">
										...
										<ul class="dropdown-menu">
											<li><a href="javascript:;" onclick="showAtRight('${base}/user/queryUser?type=专家&currPage=1&uId=${user.id}')">专家列表</a></li>
											<li><a href="javascript:;" onclick="showAtRight('${base}/user/queryUser?type=作者&currPage=1&uId=${user.id}')">作者列表</a></li>
										</ul>
									</li>
									<li class="dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: #FFF;margin:0 5px 0 5px;">
										...
										<ul class="dropdown-menu">
											<li><a href="javascript:;" onclick="showAtRight('${base}/journal/jList?JState=2&uId=${user.id}&currPage=1')">已核期刊</a></li>
											<li><a href="javascript:;" onclick="showAtRight('${base}/journal/jList?JState=1&uId=${user.id}&currPage=1')">未核期刊</a></li>
										</ul>
									</li>
									<li class="dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: #FFF;margin:0 5px 0 5px;">
										...
										<ul class="dropdown-menu">
											<li><a href="javascript:;" onclick="showAtRight('${base}/fee/queryPayFees?uId=${user.id}&currPage=1')">已付列表</a></li>
											<li><a href="javascript:;" onclick="showAtRight('${base}/fee/queryNoPayFees?uId=${user.id}&currPage=1')">未付信息</a></li>
										</ul>
									</li>
									<li class="dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: #FFF; margin:0 5px 0 5px;">
									...
									<li><a href="javascript:;" onclick="showAtRight('${base}/user/aboutSystem?id=${user.id}')" style="color: #FFF; margin:0 5px 0 5px;">关于系统</a></li>
								</ul>
							</div>
					...
					<div class="panel panel-default" style="margin-bottom: 0px;">
						...
						<div class="panel-body">
							<ul id="main-nav" class="nav nav-pills nav-stacked">
								...
								<li>
									<a href="#menu1" class="nav-header collapsed" data-toggle="collapse">
										<i class="glyphicon glyphicon-list"></i>&nbsp;&nbsp;期刊管理
										<span class="pull-right glyphicon glyphicon-chevron-down"></span>
									</a>
									<ul id="menu1" class="nav nav-list secondmenu collapse in">
										<li>
											<a href="javascript:;" onclick="showAtRight('${base}/journal/jList?JState=1&uId=${user.id}&currPage=1')">&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-time"></i>&nbsp;&nbsp;未核期刊</a>
										</li>
										<li>
											<a href="javascript:;" onclick="showAtRight('${base}/journal/jList?JState=2&uId=${user.id}&currPage=1')">&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;已核期刊</a>
										</li>
									</ul>
								</li>
								<li>
								...
								<li>
									...
									<ul id="menu2" class="nav nav-list collapse secondmenu" style="height: 0px;">
										<li>
											<a href="javascript:;" onclick="showAtRight('${base}/user/queryUser?type=专家&currPage=1&uId=${user.id}')">&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-search"></i>&nbsp;&nbsp;专家列表</a>
										</li>
										<li>
											<a href="javascript:;" onclick="showAtRight('${base}/user/queryUser?type=作者&currPage=1&uId=${user.id}')">&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-edit"></i>&nbsp;&nbsp;作者列表</a>
										</li>
									</ul>
								</li>
								
								<li>
									<a href="#menu3" class="nav-header collapsed" data-toggle="collapse">
										<i class="glyphicon glyphicon-comment"></i>&nbsp;&nbsp;消息管理
										<span class="pull-right glyphicon glyphicon-chevron-down"></span>
									</a>
									<ul id="menu3" class="nav nav-list collapse secondmenu" style="height: 0px;">
										<li>
											<a href="javascript:;" onclick="showAtRight('${base}/message/querySM?uId=${user.id}&currPage=1')">&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-envelope"></i>&nbsp;&nbsp;发件列表</a>
										</li>
										<li>
											<a href="javascript:;" onclick="showAtRight('${base}/message/queryRM?uId=${user.id}&currPage=1')">&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-send"></i>&nbsp;&nbsp;收件列表
								...
								<li>
									<a href="javascript:;" onclick="showAtRight('${base}/message/queryAM?id=${user.id}&currPage=1')">
										<i class="glyphicon glyphicon-cog"></i>&nbsp;&nbsp;消息操作
									</a>
								</li>
								<li>
									<a href="javascript:;" onclick="showAtRight('${base}/user/aboutSystem?id=${user.id}')">
										<i class="glyphicon glyphicon-leaf"></i>&nbsp;&nbsp;关于系统
									</a>
								</li>
							</ul>
						</div>				
