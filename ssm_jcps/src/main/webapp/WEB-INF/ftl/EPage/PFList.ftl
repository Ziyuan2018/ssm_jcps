									...
									<div class="dropdown" style="padding-left: 8px;">
										...
										<ul class="dropdown-menu" role="menu"
											...
											<li role="presentation"><a role="menuitem" tabindex="-1"
												href="javascript:showAtRight('${base}/fee/queryFeesByJournalId?jId=${fee.journalId}&uId=${user.id}');">费用详情</a></li>
											<li role="presentation"><a role="menuitem" tabindex="-1"
												href="javascript:showAtRight('${base}/message/answerM?uId=${user.id}&mId=${fee.writerId}');">消息留言</a></li>
										</ul>
									</div>
								</td>
							</tr>
