			...
			<div id="wInfo" class="panel-collapse collapse in">
				<div class="panel-body">
					<table class="table table-hover" style="margin-bottom: 0px">
						...
						<tbody>
							<#assign i=0>
							<#if RMPageBean?exists>
							<#list RMPageBean.list as message>
							<#assign i=i+1>
							<tr>
								<td>${message.sName}</td>
								...
								<td>
									<a href="javascript:showAtRight('${base}/message/updateMM?state=2&currPage=${RMPageBean.currPage}&mId=${message.id}&uId=${user.id}');" style="padding-left: 8px;"> 
								...
								<td>
									<a href="javascript:showAtRight('${base}/message/deleteRM?num=${i}&currPage=${RMPageBean.currPage}&mId=${message.id}&uId=${user.id}');"
										style="padding-left: 8px;"> 
					...
					<#if RMPageBean.totalPage != 0>
					<#if RMPageBean.totalPage <= 2>
						<ul class="pagination" style="padding: 0px;margin:0;">
							<#if RMPageBean.currPage == 1>
								<li>
									<a href="#" class="active">首页</a>
								</li>
							<#else>
							<li>
									<a href="javascript:showAtRight('${base}/message/queryRM?uId=${user.id}&currPage=1');">首页</a>
								</li>
							</#if>
							
							<#list 1..RMPageBean.totalPage as n>
								<li><a href="javascript:showAtRight('${base}/message/queryRM?uId=${user.id}&currPage=${n}');">${n}</a></li>
							</#list>
							<li>
								<a href="javascript:showAtRight('${base}/message/queryRM?uId=${user.id}&currPage=${RMPageBean.totalPage}');">尾页</a>
							</li>
						</ul>
					</#if>
					<#if RMPageBean.totalPage gt 2>
						<#assign i=1>
						<ul class="pagination" style="padding: 0px;margin:0;">
							<#if RMPageBean.currPage gt 1>
							<li><a href="javascript:showAtRight('${base}/message/queryRM?uId=${user.id}&currPage=${RMPageBean.currPage-i}');">上一页</a></li>
							<#else>
							<li><a href="#">上一页</a></li>
							</#if> 
							<li><a href="#">${RMPageBean.currPage}</a></li>
							<#if RMPageBean.currPage == RMPageBean.totalPage>
							<li><a href="#">下一页</a></li>
							<#else>
							<li><a href="javascript:showAtRight('${base}/message/queryRM?uId=${user.id}&currPage=${RMPageBean.currPage+i}');">下一页</a></li>
							</#if>
						</ul>
						</#if>
						<ul class="pagination" style="margin:0 0 0 20px;padding: 0px;">
						<li><a href="#" class="active">第</a></li>
						<li><a href="#">${RMPageBean.currPage} / ${RMPageBean.totalPage}</a></li>
