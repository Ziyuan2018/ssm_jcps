				...
				<div class="panel-body">
					<table class="table table-hover" style="margin-bottom: 0px">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="javascript:showAtRight('${base}/message/answerM?uId=${user.id}&mId=${fee.writerId}');"
					...
					<#if fPageBean.totalPage <= 2>
						<ul class="pagination" style="padding: 0px;margin:0;">
							...
							<#else>
							<li><a href="javascript:showAtRight('${base}/fee/queryNoPayFees?uId=${user.id}&currPage=1');">首页</a>
							</li> 
							</#if> 
							<#list 1..fPageBean.totalPage as n>
							<li><a href="javascript:showAtRight('${base}/fee/queryNoPayFees?uId=${user.id}&currPage=${n}');">${n}</a></li>
							</#list>
							<li><a href="javascript:showAtRight('${base}/fee/queryNoPayFees?uId=${user.id}&currPage=${fPageBean.totalPage}');">尾页</a>
							</li>
						</ul>
					</#if> 
					...
					<#assign i=1>
						<ul class="pagination" style="padding: 0px;margin:0;">
							...
							<li><a href="javascript:showAtRight('${base}/fee/queryNoPayFees?uId=${user.id}&currPage=${fPageBean.currPage-i}');">上一页</a></li>
							<#else>
							<li><a href="#">上一页</a></li>
							</#if> 
							...
							<li><a href="#">下一页</a></li>
							<#else>
							<li><a href="javascript:showAtRight('${base}/fee/queryNoPayFees?uId=${user.id}&currPage=${fPageBean.currPage+i}');">下一页</a></li>
							</#if>
						</ul>
					</#if>
